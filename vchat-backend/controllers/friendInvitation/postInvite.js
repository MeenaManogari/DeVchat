  ...
  try {
    ...
    if (!targetUser) {
      return res
        .status(404)
        .send(
          `Friend of ${targetMailAddress} has not been found.Please check the mail`
        );
    }
    ...
    //check if the user which we like to invite is already our friend
    ...
    //Update friends invitation list ,if invitation has been successfully sent.
